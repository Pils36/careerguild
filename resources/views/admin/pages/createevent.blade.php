        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form action="{{ route('eventpost') }}" method="POST" enctype="multipart/form-data" id="publish_event">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group has-success">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control timepicker" name="event_start_time">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-success">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control timepicker" name="event_end_time">
                                    <div class="input-group-addon">
                                    <i class="fa fa-clock-o"></i>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-success">
                                ...
                                <input type="text" name="location" id="location" class="form-control" placeholder="https://example.com">
                            </div>
                        </div>
                    </div>
                    ...
                    <br>
                    <button type="button" onclick="eventPublish()" class="btn btn-primary btn-block">Submit</button>
