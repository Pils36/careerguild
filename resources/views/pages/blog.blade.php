                    ...
                    <article class="post">
                        ...
                        <div class="post-wrapper">
                            <div class="post-header">
                                <h2 class="post-title"><a href="/blogdetail/{{ $blog->id }}">{{ $blog->subject }}</a></h2>
                                <ul class="post-meta">
                            ...
                            <div class="post-more pt-4 align-items-center d-flex"><a href="/blogdetail/{{ $blog->id }}" class="btn secondary-solid-btn">Continue reading <span class="ti-arrow-right"></span></a></div>
                        </div>
                    </article>
                    <!-- Post end-->
                    ...
                    <div class="sidebar-right pl-4">
                        ...
                        <aside class="widget widget-recent-entries-custom">
                            ...
                            <ul>
                                ...
                                @foreach ($data[0]['blogdata'] as $recent)
                                   <li class="clearfix">
